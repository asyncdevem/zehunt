...
export default function NewUpdatePage() {
  return (
    <PlatformShell
      title="Create Structured Update"
      subtitle="Log execution events that feed your builder reputation score and opportunity matching."
    >
      <div className="mb-6 flex flex-wrap items-center gap-3">
        <StickyLabel>Build-in-Public Input</StickyLabel>
        <RoughPill>Evidence over hype</RoughPill>
      </div>
      ...
      <WobblyCard className="bg-white max-w-3xl" rotate={1}>
        <form className="space-y-4">
          ...
          <div>
            ...
            <textarea
              rows={5}
              placeholder="Describe the shipped work, measurable outcome, and what changed in lifecycle maturity."
              className="w-full border-[3px] border-[#2d2d2d] bg-white px-4 py-3 text-lg placeholder:text-[#2d2d2d]/50 focus:border-[#2d5da1] focus:outline-none"
