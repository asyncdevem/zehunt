  ...
  return (
    <div className="min-h-screen text-[#2d2d2d] selection:bg-[#ff4d4d] selection:text-white">
      <header className="border-b-[3px] border-[#2d2d2d] bg-[#fdfbf7]/95">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/signup"
              className="inline-flex h-10 items-center border-[2px] border-[#2d2d2d] bg-white px-4 text-sm font-bold transition-all duration-100 hover:bg-[#ff4d4d] hover:text-white"
      ...
      <main className="mx-auto flex w-full max-w-6xl justify-center px-4 py-10 sm:px-6 lg:px-8">
        <WobblyCard className="w-full max-w-xl bg-white" rotate={1}>
          <StickyLabel>Welcome back</StickyLabel>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight">Log In to Zehunt</h1>
          <p className="mt-2 text-lg">Continue tracking builder execution, reputation growth, and opportunity matches.</p>
          ...
          <form className="mt-6 space-y-4">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                ...
                <Link href="#" className="text-sm font-bold underline decoration-2 underline-offset-2 hover:text-[#ff4d4d]">
                  Forgot?
                </Link>
              </div>
              <input
            ...
            <div className="pt-2">
              <WobblyButton className="w-full">
                <span className="inline-flex items-center gap-2">
                  <KeyRound className="h-4 w-4" strokeWidth={2.8} />
                  Log In
                </span>
              </WobblyButton>
            </div>
          ...
          <p className="mt-4 text-center text-base font-semibold">
            New to Zehunt?{' '}
            <Link href="/signup" className="underline decoration-2 underline-offset-2 hover:text-[#ff4d4d]">
